 ...
 *  
 *@author     Jarmila Pavlickova, Štěpánka Dostálková
 *@version    ZS 2020/21
 *  
 */
...
class PrikazKonec implements IPrikaz {
    ...
    public String provedPrikaz(String... parametry) {
        if (parametry.length > 0) {
            ...
            return "Ty jsi to vzdal? Co jsi to za zachránce.. mumie nakonec kopí získala a nastolila teror. Svět se řítí to temnoty.";
        }
    }
